            ...
            try
            {
                ...
                if (dr != null)
                {
                    while (dr.Read())
                    {
                        ...
                        _row["numero_funcionario"] = dr.GetString(1);
                        _row["producto"] = dr.GetString(2);
                        _row["subproducto"] = dr.GetString(3);
                        _row["fecha_alta"] = dr.GetString(4);
                        _row["fecha_baja"] = dr.GetString(5);
                        _row["fecha_ultimo_mant"] = dr.GetString(6);
                        _row["tipo_peticion"] = dr.GetString(7);
                        _row["status_envio"] = dr.GetInt32(8);
                        _row["columna_11"] = dr.GetString(9);
                        _row["columna_12"] = dr.GetString(10);
                        _row["id_transaccion"] = dr.GetInt32(11);
                        _row["tipo"] = dr.GetString(12);
            ...
            try
            {
                ...
                if (dr != null)
                {
                    while (dr.Read())
                    {
                        ...
                        _row["numero_funcionario"] = dr.GetString(1);
                        _row["id_transaccion"] = dr.GetString(2);
                        _row["codigo_operacion"] = dr.GetString(3);
                        _row["cuenta"] = dr.GetString(4);
                        _row["divisa"] = dr.GetString(5);
                        _row["importe"] = dr.GetString(6);
                        _row["fecha_operacion"] = dr.GetString(7);
                        _row["folio_autorizacion"] = dr.GetString(8);
                        _row["status_envio"] = Int64.Parse(dr.GetString(9));
                        _row["fecha"] = dr.GetByte(10);
                        _row["hora"] = dr.GetString(11);
